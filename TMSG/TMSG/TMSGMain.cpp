...
TMSGMain::TMSGMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void TMSGMain::CreateWindowSizeDependentResources() 
{
...
void TMSGMain::OnDeviceRestored()
{
